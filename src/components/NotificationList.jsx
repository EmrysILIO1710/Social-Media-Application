...
const NotificationList = () => (
  <div class="relative">
    <div class="z-10 flex w-screen max-w-max  ">
      <div class="w-screen max-w-md flex-auto overflow-hidden rounded-3xl bg-white text-sm leading-6 px-4 ring-gray-900/5">
        <div>
          <NotificationItem
            imgSrc={profileimg1}
            title="Yesterday"
...
>>>>>>> 5243658e7e10157bd6a04441fff75c7bf319b763
          </div>
        </div>
      </div>
    </div>
