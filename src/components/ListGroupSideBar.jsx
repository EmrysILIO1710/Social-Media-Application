...
function ListGroupSideBar(props) {
  ...
  return (
    <div
      className={`z-50 top-0 h-fit overflow-y-auto bg-transparent text-black w-80 ${props.position}`}
    >
      ...
      <div className="space-y-4 px-4" style={{ color: modetext }}>
        ...
        {/* logout area */}
        {/* <div
          className="self-end list-group-item my-1 py-3 lh-sm bg-transparent no-underline transition-transform duration-200 ease-in-out transform hover:-translate-y-1 hover:shadow-md active:shadow-none hover:cursor-pointer text-decoration-none"
          onClick={() => {
            setOpen(true);
          }}
        >
