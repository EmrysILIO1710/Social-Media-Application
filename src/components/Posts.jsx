            ...
            <div className="Post-container">
                ...
                <div className="Post-comment-section" style={{display: dispcomm}}>
                    ...
                    <form onSubmit={submitComment}>
                        <input type="text" className="Post-comment" value={comm} onChange={changeComment} placeholder="share your thoughts..." />
                        ...
                        (comments.length !== 0)? (
                            comments.map((item, key) => (
                                <div key={item.commId} className="Post-comment-section2">
                                    <span>
                                        <span style={{fontWeight: "bold"}}>YOU:</span> {item.commVal} &nbsp;&nbsp;
                                        <img src={deletecomm} alt="" className="Post-delete-comm" onClick={() => {
