...
export default function Navbar(props) {
  ...
  return (
    ...
    >
      {({ open }) => (
        <>
          <div className="mx-auto max-w-screen-xl px-1 md:px-6 lg:px-8 z-30">
                ...
                <Menu as="div" className="relative ml-6">
                  <div>
                    {props.icon ? (
                      <Link
                        to={"/profilepage"}
                        className="relative  flex flex-shrink-0 rounded-full p-2 text-sm focus:outline-none focus:ring-offset-2 focus:ring-offset-gray-800 "
                      >
                      ...
                      <Link to={"/setting"} className="text-black">
                        <button
                          type="button"
